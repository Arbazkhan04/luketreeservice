    ...
    return (
        <div className="flex flex-col items-center w-full">
            <div className="container mx-auto px-4 py-3 mt-3">
                <div className="flex flex-col md:flex-row gap-2.5 px-5 mt-3 w-full">
                    <div className="order-2 md:order-1 flex-1 text-3xl font-semibold leading-10 text-slate-900">
                        Reviews
                    </div>
                    <div className="order-3 md:order-2 flex gap-1.5">
                    ...
                    <div onClick = {handleWriteReview} className="order-1 md:order-3 w-full md:w-[30%] text-base font-semibold leading-6 text-white bg-blue-600 border-2 border-blue-400 shadow-[0px_2px_0px_rgba(0,0,0,0.30)] rounded-full flex justify-center items-center py-3 cursor-pointer">
                        Write a Review
                    </div>
                </div>
